...
function start()
{
	...
	oceanMeshMaterial = new THREE.MeshBasicMaterial( { color: 0x9900FF, wireframe: true, transparent: true, opacity: 1.0 } );
	blackMaterial = new THREE.MeshBasicMaterial( { color: 0xFF0000, wireframe: false, transparent: false, opacity: 1.0 } );


	oceanUniforms = {
		u_color : { type: "c", value: new THREE.Color( 0x3366FF ) }
	};
...
/*
     FILE ARCHIVED ON 21:28:15 Dec 15, 2022 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.009
  cdx.remote: 8.537
  LoadShardBlock: 129.027 (3)
  PetaboxLoader3.datanode: 141.176 (4)
  load_resource: 334.586
  PetaboxLoader3.resolve: 301.12
*/